...
class mbsb_sermon extends mbsb_spss_template {
	...
	*/
	private function get_frontend_section ($section) {
		...
		} else if ($section == 'media' && $this->attachments->get_attachments()) {
		...
		} else if ($section == 'preacher' && $this->preacher->present) {
		...
		} else if ($section == 'series' && $this->series->present) {
		...
		} else if ($section == 'passages' && $this->passages->present) {
	...
	* @param string|array $attr Optional. Query string or array of attributes.
	...
	public function get_thumbnail($attr) {
		...
		} else if (has_post_thumbnail($this->series->id)) {
			return get_the_post_thumbnail($this->series->id, 'mbsb_sermon', $attr);
		} else if (has_post_thumbnail($this->preacher->id)) {
			return get_the_post_thumbnail($this->preacher->id, 'mbsb_sermon', $attr);
		} else if (has_post_thumbnail($this->service->id)) {
